...
public static class CsSigWriter
{
    ...
    public static string Write(IAssemblySymbol assembly, ISet<string>? topLevelKeys)
    {
        ...
        builder.AppendLine(
            "// Auto-generated by the CsSig analyzer code fix from the project's public API."
        );
        builder.AppendLine("// Do not edit manually; rerun the fix or 'dotnet format' to regenerate.");
        builder.AppendLine("");
        var first = true;
