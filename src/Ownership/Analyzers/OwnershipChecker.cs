...
public sealed class OwnershipChecker : DiagnosticAnalyzer
{
    internal const string RuleId = "CA2000";

    internal static readonly DiagnosticDescriptor NotDisposedRule = DiagId.LinearResourceMissingDispose.GetDescriptor();
    internal static readonly DiagnosticDescriptor MayBeDisposedRule = null!;
    internal static readonly DiagnosticDescriptor NotDisposedOnExceptionPathsRule = null!;
    internal static readonly DiagnosticDescriptor MayBeDisposedOnExceptionPathsRule = null!;
    public override ImmutableArray<DiagnosticDescriptor> SupportedDiagnostics { get; } = ImmutableArray.Create(NotDisposedRule);
