...
public sealed partial class CancelScope
{
    ...
    private CancelScope(CancelScope parent)
    {
        ...
        _cts = CancellationTokenSource.CreateLinkedTokenSource(parent._cts.Token);
    }
}
...
partial class CancelScope
{
    ...
    public static CancelScope Current
    {
        get
        {
            ...
            {
                _current.Value = new CancelScope();
            }
    ...
    {
        return WithTimeoutAfter(delay, scope => Task.FromResult(func(scope)), onCanceled)
            .GetAwaiter()
            .GetResult();
    }
