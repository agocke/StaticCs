...
namespace FastEnum
{
    public static class LinqExtensions
    {
        ...
        public static WhereEnumerator<T, TEnumerator> Where<T, TEnumerator>(this TEnumerator e, Func<T, bool> pred)
            where TEnumerator : IFastEnumerator<T>
            => new WhereEnumerator<T, TEnumerator>(e, pred);
        ...
        public static SelectEnumerator<T, U, TEnumerator> Select<T, U, TEnumerator>(this TEnumerator e, Func<T, U> pred)
            where TEnumerator : IFastEnumerator<T>
            => new SelectEnumerator<T, U, TEnumerator>(e, pred);
    ...
    public readonly struct SelectEnumerable<T, U, TEnumerable, TEnumerator> : IEnumerable<U, SelectEnumerator<T, U, TEnumerator>>
        where TEnumerable : IEnumerable<T, TEnumerator>
        where TEnumerator : IFastEnumerator<T>
    {
        private readonly TEnumerable _e;
        ...
        public SelectEnumerator<T, U, TEnumerator> GetEnumerator()
            => new SelectEnumerator<T, U, TEnumerator>(_e.GetEnumerator(), _map);
    }

    public struct SelectEnumerator<T, U, TEnumerator> : IFastEnumerator<U>
        where TEnumerator : IFastEnumerator<T>
    {
        private readonly Func<T, U> _map;
        private TEnumerator _e;
